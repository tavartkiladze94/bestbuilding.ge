...
class Main extends CI_Controller {
	...
	public function index()
	{
	    ...
	    $data['project_black'] = $this->main_model->get_best_project("black_sea_towers");
        $data['vila_axalsofeli'] = $this->main_model->get_best_project("vila_axalsofeli");
        $data['materials'] = $this->main_model->get_main_materials();
	    $data['news'] = $this->main_model->get_main_news();
	    
	    $data["content"] = "სამშენებლო კომპანია Bestbuilding აწარმოებსს მეტალის სხვადასხვა კონსტრუქციებს: აივნის მოაჯირები, კიბის მოაჯირები, გისოსები, კარები, ხარაჩოებ, კედლის საყალიბე მასალა, შერის საყალიბე მასალა, სამშენებლო სტენდი და სხვა...";
	...
	{ 
	    ...
	    $arr["ip_addr"] = $this->input->ip_address();
	    $history_view_update = $this->main_model->update_page_history_view($arr);
	    $data['projects'] = $this->main_model->get_best_projects();
	    $data["view"] = $arr["view"];
	    $data["content"] ="";
	    $data["content"] = "სამშენებლო კომპანია,ბესთ ბილდინგი სამშენებლო, სარემონტო სფეროში არსებულ, ინოვაციურ-კრეატიულ გუნდს წარმოადგენს. კომპანია შპს ბესთ ბილდინგ დაფუძნდა 2020 წლის 24 მარტს. კომპანია აერთიანებს იმ ადამიანების ჯგუფს, რომლებიც ბოლო 10-12 წლის განმავლობაში საქართველოს სხვადასხვა რეგიონებში აწარმოებდნენ და უშუალოდ მონაწილეობას ღებულობდნენ სამშენებლო სარემონტო საპროექტო სამუშაოებში... ";  
		$this->load->view('layouts/header',$data);
	...
	{  
	    ...
	    $data['project_details'] = $this->main_model->get_best_project($code);
	    $data['images'] = array();
	...
	public function news()
	{
	    ...
	    $arr["ip_addr"] = $this->input->ip_address();
	    $history_view_update = $this->main_model->update_page_history_view($arr);
	    $data['news'] = $this->main_model->get_best_news();
	    $data["view"] = $arr["view"];
	    $data["newss"] = "News";
	    $data["content"] ="";
	    $data["content"] = "სამშენებლო კომპანია,ბესთ ბილდინგი სამშენებლო, სარემონტო სფეროში არსებულ, ინოვაციურ-კრეატიულ გუნდს წარმოადგენს. კომპანია შპს ბესთ ბილდინგ დაფუძნდა 2020 წლის 24 მარტს. კომპანია აერთიანებს იმ ადამიანების ჯგუფს, რომლებიც ბოლო 10-12 წლის განმავლობაში საქართველოს სხვადასხვა რეგიონებში აწარმოებდნენ და უშუალოდ მონაწილეობას ღებულობდნენ სამშენებლო სარემონტო საპროექტო სამუშაოებში... ";  
	...
	public function news_details($code)
	{
	    ...
	    $data['images'] = 0;
	    $data['imagess'] = 0;
	    $data['news_details'] = $this->main_model->get_best_news_details($code);
