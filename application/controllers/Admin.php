    ...
    $page = ($this->uri->segment(3)) ? $this->uri->segment(3) : 0;
      ...
      $config = array();
       ...
       // $choice = $config["total_rows"] / $config["per_page"];
        ...
        $mbox=imap_open("{mail.arsigroup.ge}", "director@arsigroup.ge", "sevenl0509") or die('Cannot connect to email: ' . imap_last_error());
        $MC=imap_check($mbox); 
        $MN=$MC->Nmsgs; 
        ...
        $data["emails"] = json_decode(json_encode($overview), true);
        $data["size"] = $size;
	...
	public function loginn()
	{
        ...
        if ($validate && ($validate[0]->validation=='1')){
            $newdata = array(
                ...
                'material' => $validate[0]->material,
                'sagareo' => $validate[0]->sagareo,
                'category' => $validate[0]->category,
                'object' => $validate[0]->object,
                'logged_in' => TRUE,
                'Real_Palace' => $validate[0]->Real_Palace,
                'Villa_Akhalsopeli_Batumi' => $validate[0]->Villa_Akhalsopeli_Batumi,
                'Maqacaria' => $validate[0]->Maqacaria,
                'Villa_Gonio' => $validate[0]->Villa_Gonio,
                'Villa_Akhalsopeli_Khelvachauri' => $validate[0]->Villa_Akhalsopeli_Khelvachauri,
                'Maxinjauri_House' => $validate[0]->Maxinjauri_House
      ...
      if($this->input->post('email') != '')
     {
         ...
         if (!empty($data["gagzavnili_files"]))
         {
             foreach ($data["gagzavnili_files"] as $sms_item)
             {
                 ...
                 $msg .='<div style="width:100%;background-color: #373334!important;"> <img  src="https://www.bestbuilding.ge/assets/images/'.$link.'" style="border-radius: 0; width:160px; height:100px;" alt="">
           <font style="color:#f1d766!important;">'.$sms_item["file_name"].'- </font><a href="https://www.bestbuilding.ge/assets/images/finansebi/'.$sms_item["file_name"].'" download style="background-color:#7367F0!important;color:#f1d766!important;"> ჩამოტვირთვა</a></div>';
      ...
      if($this->input->post('email') != '')
     {
         ...
         if (!empty($data["gagzavnili_files"]))
         {
             foreach ($data["gagzavnili_files"] as $sms_item)
             {
                 ...
                 $msg .='<div style="width:100%;background-color: #373334!important;"> <img  src="https://www.bestbuilding.ge/assets/images/'.$link.'" style="border-radius: 0; width:160px; height:100px;" alt="">
           <font style="color:#f1d766!important;">'.$sms_item["file_name"].'- </font><a href="https://www.bestbuilding.ge/assets/images/iuridiuli/'.$sms_item["file_name"].'" download style="background-color:#7367F0!important;color:#f1d766!important;"> ჩამოტვირთვა</a></div>';
...
public function brigadiri_migebuli()
      ...
      if($this->input->post('email') != '')
     {
         ...
         if (!empty($data["gagzavnili_files"]))
         {
             ...
             { if($sms_item['file_ext'] == '.jpg' || $sms_item['file_ext']== '.jpeg' || $sms_item['file_ext']=='.png')
                 ...
                 $msg .='<div style="width:100%;background-color: #373334!important;"> <img  src="https://www.bestbuilding.ge/assets/images/'.$link.'" style="border-radius: 0; width:160px; height:100px;" alt="">
           <font style="color:#f1d766!important;">'.$sms_item["file_name"].'- </font><a href="https://www.bestbuilding.ge/assets/images/brigadiri/'.$sms_item["file_name"].'" download style="background-color:#7367F0!important;color:#f1d766!important;"> ჩამოტვირთვა</a></div>';
      ...
      $this->session->set_flashdata('alertype', 'success');
         ...
         if (!empty($data["gagzavnili_files"]))
         {
             ...
             { $ff= "";
                 ...
                 $msg .='<div style="width:100%;background-color: #373334!important;"> <img style="border-radius: 0; width:160px; height:100px;" src="https://www.bestbuilding.ge/assets/images/'.$ff.'" alt="">
          <font style="color:#f1d766!important;">'.$sms_item["file_name"].'- </font> <a href="https://www.bestbuilding.ge/assets/images/sms_gagzavnili/'.$sms_item["file_name"].'" download style="background-color:#7367F0!important;color:#f1d766!important;"> ჩამოტვირთვა</a></div>';
             }
         }
        $this->email->from('bestbilding20@gmail.com', "ბესთბილდინგ");
        $this->email->to($this->input->post('email'));
        $this->email->subject($this->input->post('subject'));
        $this->email->message('<div style="width:100%;height:80px;"><img style="width:140px; height:90px;" src="http://www.bestbuilding.ge/assets/images/llllog.jpg"/></div> <h3>გამომგზავნი : ბესთბილდინგი</h3><h3>მობილური: (+995 557 62 60 91)</h3><h3>ვებ გვერდი: <a href="https://www.bestbuilding.ge/main/index"> WWW.BESTBUILDING.GE</a></h3><br>'.$this->input->post('text').'<br> მიბმული ფაილები:<br>'.$msg);
        //Send mail
        $this->email->send();
   ...
   public function sms_gagzavnili_details($code)
  {
	...
	public function problem_create()
	{
       ...
       /* $this->email->from("info@bestbuilding.ge", "უსაფრთხოება ");
        ...
        $this->email->message(" ობიექტი - ".$this->lang->line($this->input->post('object'))."
         ...
         tp://www.bestbuilding.ge/admin/problem_edit_red/".$code);
        //Send mail
        $this->email->send(); */
        $this->session->set_flashdata('alert', 'ჩანაწერი წარმატებით დაემატა');
	    $this->session->set_flashdata('alertype', 'success');
