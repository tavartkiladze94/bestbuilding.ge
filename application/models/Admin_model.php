...
class Admin_model extends CI_Model {
		...
		$this->db->insert('best_current_work');
        ...
        public function get_current_work_list($limit, $start)
        {
            ...
            $this->db->select('*');
             $this->db->order_by("id", "desc");
             $this->db->from('best_current_work');
             $this->db->limit($limit, $start);
             $query=$this->db->get();
             return $query->result_array();
        }
        ...
        {
            $query = $this->db->get_where('best_current_work', array('code' => $code));
            $this->db->order_by("id", "desc");
            $query->num_rows();
        ...
        public function insert_current_work_photo($data,$code, $object_code)
        {
            ...
            $this->db->set('code', $code);
            $this->db->set('object_code', $object_code);
            $this->db->insert('best_current_work_images');
        }
         ...
         public function current_work_update($code, $postdata)
        {
            ...
            //$this->db->where('reg_name', $this->session->userdata('name'));
            //$this->db->where('reg_surname', $this->session->userdata('surname'));
            $this->db->update('best_current_work', $postdata);
        }
         ...
         public function current_work_delete($code)
        {
                ...
                //$this->db->where('reg_name', $this->session->userdata('name'));
                //$this->db->where('reg_surname', $this->session->userdata('surname'));
                $this->db->delete('best_current_work');
        }
        ...
        {
                $this->db->where('file_name', $file_name);
                $this->db->delete('best_current_work_images');
        }
         public function current_work_main_image($file_name, $code)
        {
                ...
                $this->file_name     = $file_name;
                $this->db->update('best_current_work', $this);
        }
        ...
        {
            $query = $this->db->get_where('best_news', array('code' => $code));
            $this->db->order_by("id", "desc");
            $query->num_rows();
        ...
        public function insert_news_photo($data,$code)
        {
            ...
            $this->db->set('date', $date);
            $this->db->set('code', $code);
            $this->db->insert('best_news_images');
        }
         ...
         public function news_update($code, $postdata)
        {
            ...
            //$this->db->where('reg_name', $this->session->userdata('name'));
            //$this->db->where('reg_surname', $this->session->userdata('surname'));
            $this->db->update('best_news', $postdata);
        }
        ...
        {
                $this->db->where('file_name', $file_name);
                $this->db->delete('best_news_images');
        }
