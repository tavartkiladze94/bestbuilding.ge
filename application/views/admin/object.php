...
<section id="basic-datatable">
    ...
    <div class="card-datatable table-responsive pt-0">
        ...
        <div class="objects" >
				    ...
				    <a href="<?=base_url('admin/object_news/');?><?php echo $object;?>"><img src="https://www.bestbuilding.ge/assets/images/news.png" style="width:100%; "/></a>
				</div>
				 <div class="objects" >
			
				   <a href="<?=base_url('admin/object_problems/');?><?php echo $object;?>"> <img src="https://www.bestbuilding.ge/assets/images/secure.png" style="width:100%; "/></a>
				</div>
    </div>
