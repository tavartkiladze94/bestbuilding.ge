...
<h2 class="text-uppercase heading border-bottom mb-4" style="padding-bottom:0;font-size:37px;color:#f1d766;"><?=$this->lang->line('Current projects');?></h2>
<hr class="hrr">
</div>
...
<div class="media-body">
    <img src="<?=base_url();?>assets/images/projects/<?php echo $projects_item['file_name']; ?>" alt="<?php echo $projects_item[$this->lang->line('project_title_lang')]; ?>" style="width:100%; height:270px;">
<h3 class="mt-0 text-black" style="margin-top:20px!important; font-weight:bold; font-size:18px;"><?php echo $projects_item[$this->lang->line('project_title_lang')]; ?></h3>
<p><a href="<?=base_url('main/project_details');?>/<?php echo $projects_item['code']; ?>" class="btn btn-outline-primary btn-sm"><?=$this->lang->line('View more');?></a></p>
</div>
</div>
</div>
	<?php endforeach; ?>
